def defineSettings(parHandle):
    ...
    parHandle.curExercise['settings']['comment'] = 'This is a setting which uses a different and simpler audio engine.'
    parHandle.curExercise['settings']['settingsName']       = 'shorterSetting.py'

    parHandle.curExercise['settings']['player'] = 'playAudio'
